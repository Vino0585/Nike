...
from Inventory.Inventory_Payload_Generation.Inventory_MHE_Journal_Payload import Inventory_MHE_Journal_Payload
...
class MHE_Journal_Inventory:
    ...
    def create_mhe_journal_inventory(self):
        mhe_instance = Inventory_MHE_Journal_Payload()
        raw_payloads = mhe_instance.create_inventory_mhe_journal_payloads()
