...
from Inbound.Inbound_payload_generation.Routing_Task_Completed_Payload import Routing_Task_Completed_Payload
...
class Routing_Task_Completed:
    ...
    def create_routing_task_complete():
        ...
        for package in raw_payloads:
            ...
            payload = package.get('RoutingPayload')
            ...
            try:
                ...
                for i, payload_to_send in enumerate(payloads):
                    try:
                        ...
                        logging.error(f"ERROR: An unexpected error occured for payload {i + 1}: {e}")
            except Exception as e:
                logging.error(
