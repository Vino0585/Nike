...
from Inbound.Inbound_payload_generation.Inbound_Delivery_Payload import Inbound_Delivery_Payload
...
class Inbound_Delivery:

    def post_asn_to_delivery(self, payload_info: Dict[str, Any], env_handler: AWM_Env):
    ...
    def send_inbound_delivery(self):
        """
        ...
        for payload_info in payloads:
            self.post_asn_to_delivery(payload_info, env_handler)
