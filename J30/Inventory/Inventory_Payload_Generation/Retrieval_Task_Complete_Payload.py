...
class Recall_Retrieval_Task_Payload:
    ...
    def __init__(self):
        self.get_task_info_payload = Task_Search_Payload()
        self.all_recall_retrieval_payloads = []

   def create_recall_retrieval_task_payload(self) -> list:
       raw_payload = self.get_task_info_payload.get_iLPN_information_worksheet()
