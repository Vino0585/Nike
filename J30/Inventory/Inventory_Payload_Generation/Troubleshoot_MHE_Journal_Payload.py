...
class Troubleshoot_MHE_Journal_Payload:

    def __init__(self):
        self.inventory_worksheet = Inventory_WorkSheet_Extract()
        self.all_mhe_journal_payloads = []

    def create_troubleshoot_mhe_journal_payloads(self) -> list:
...
if __name__ == "__main__":
    initiation = Troubleshoot_MHE_Journal_Payload()
    payload = initiation.create_troubleshoot_mhe_journal_payloads()
    for load in payload:
