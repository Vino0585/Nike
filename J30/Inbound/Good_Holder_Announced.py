...
from Inbound.Inbound_payload_generation.Goods_Holder_Payload import Goods_Holder_Announced_Payload
...
class Goods_Holder_Announced:
    ...
    @staticmethod
    def send_goods_holder_announced():
        gha_instance = Goods_Holder_Announced_Payload()
        ...
        for package in raw_payloads:
            ...
            if not isinstance(package, dict):
                logging.info(f"WARNING: Skipping package as it's not a valid dictionary: {package}")
                continue
