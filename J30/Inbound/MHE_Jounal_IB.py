...
from Inbound.Payload_generation.IB_MHE_Journal_Payload import IB_MHE_Journal_Payload

# Setup basic logging to provide better feedback than logging.info()
logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')

class MHE_Journal_Inbound:

    def create_mhe_journal_inbound(self):
        mhe_instance = IB_MHE_Journal_Payload()
        raw_payloads = mhe_instance.create_mhe_journal_payloads()
