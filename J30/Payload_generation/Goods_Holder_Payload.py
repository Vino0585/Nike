...
class Goods_Holder_Measured:
    ...
    def __init__(self):
        ...
        # This instance variable isn't strictly necessary if only used in one method,
        # but we'll keep it for consistency with your original structure.
        self.all_goods_holder_measured = []


    def create_goods_holder_measure_payload(self) -> list:
        """
        Generates a list of GOODSHOLDER_Measured payloads from worksheet data.
        """
        ...
        for entry in goods_holder_data:
            ...
            if entry_payloads:
                ghm_payload = {
                    'environment': envn,
                    'plant': plant,
                    'GHMPayload': entry_payloads
                }

                self.all_goods_holder_measured.append(ghm_payload)

        return self.all_goods_holder_measured
